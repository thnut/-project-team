...
function initialize() { // ฟังก์ชันแสดงแผนที่  
    ...
    origin=new GGM.LatLng(13,100); // ให้ตำแหน่งจุดเริ่มต้น เท่ากับจุดที่คลิกในแผนที่  
    destination=new GGM.LatLng(20,100); // ให้ตำแหน่งจุดปลายทาง เท่ากับจุดที่คลิกในแผนที่  
